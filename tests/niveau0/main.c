...
struct textures_s{
    ...
    SDL_Texture* personnage; /*!< Texture liée à l'image du fond de l'écran. */
    /* A COMPLETER */
};
         ...
         if(event->type == SDL_KEYDOWN){
             ...
             if(event->key.keysym.sym == SDLK_DOWN){
              ...
              if(event->key.keysym.sym == SDLK_RIGHT){
                 printf("La touche 'droite' est appuyée\n");
                 world->x+=MOVING_STEP;
              }
              if(event->key.keysym.sym == SDLK_LEFT){
                 printf("La touche 'gauche' est appuyée\n");
                 world->x-=MOVING_STEP;
              }
              if(event->key.keysym.sym == SDLK_ESCAPE){
                 printf("La touche 'echap' est appuyée\n");
                 world->gameover = MOVING_STEP;
              }
         }
    }
}
...
void  init_textures(SDL_Renderer *renderer, textures_t *textures){
    ...
    textures->personnage = load_image( "ressources/sprite.bmp", renderer);
...
void refresh_graphics(SDL_Renderer *renderer, world_t *world,textures_t *textures){
    ...
    apply_texture(textures->personnage, renderer, world->x, world->y);
